...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) id <BacktraceClientCustomizing, BacktraceLogging, BacktraceMetricsProtocol, BacktraceReporting> _Nullable shared;)
+ (id <BacktraceClientCustomizing, BacktraceLogging, BacktraceMetricsProtocol, BacktraceReporting> _Nullable)shared SWIFT_WARN_UNUSED_RESULT;
+ (void)setShared:(id <BacktraceClientCustomizing, BacktraceLogging, BacktraceMetricsProtocol, BacktraceReporting> _Nullable)value;
...
@property (nonatomic, readonly, strong) BacktraceMetrics * _Nonnull metricsInstance;
...
/// <code>NSApplication</code> subclass to catch additional exceptions on macOS
SWIFT_CLASS("_TtC9Backtrace34BacktraceCrashExceptionApplication")
@interface BacktraceCrashExceptionApplication : NSApplication
/// Catch all exceptions and send them to <code>Backtrace</code>
...
@protocol BacktraceMetricsDelegate;

SWIFT_CLASS("_TtC9Backtrace16BacktraceMetrics")
@interface BacktraceMetrics : NSObject
@property (nonatomic, strong) id <BacktraceMetricsDelegate> _Nullable summedEventsDelegate;
@property (nonatomic, strong) id <BacktraceMetricsDelegate> _Nullable uniqueEventsDelegate;
...
@class BacktraceMetricsResult;

/// Events produced by <code>BacktraceMetrics</code> class.
SWIFT_PROTOCOL("_TtP9Backtrace24BacktraceMetricsDelegate_")
@protocol BacktraceMetricsDelegate
@optional
/// Event executed before HTTP request to Backtrace services is made.
/// Allows the delegate object to modify request right before sending.
...
/// Event executed after receiving HTTP response from Backtrace services.
/// Allows the delegate object to react after receiving a response.
/// \param result Backtrace metrics result.
///
- (void)serverDidRespond:(BacktraceMetricsResult * _Nonnull)result;
/// Event executed when connection to Backtrace services failed.
/// Allows the delegate object to react when connection fails.
/// \param error Error containing information about the failure cause.
///
...
SWIFT_CLASS("_TtC9Backtrace22BacktraceMetricsResult")
@interface BacktraceMetricsResult : NSObject
